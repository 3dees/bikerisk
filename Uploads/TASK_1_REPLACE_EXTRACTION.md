# TASK 1: Replace extract_ai.py

## What This Does
Replaces the extraction module with better AI prompt that captures vague language, detects images, and flags safety notices.

## Instructions
1. Locate `extract_ai.py` in your project
2. Make a backup: `mv extract_ai.py extract_ai_OLD.py`
3. Create new `extract_ai.py` with the code below
4. Save and close

## The New Code

Copy this entire code block into `extract_ai.py`:
...
After saving:
1. Don't restart anything yet
2. Just verify the file exists: `ls -la extract_ai.py`
3. Move to Task 2
...
**Next:** TASK 2 (updating app.py display)
